...
public class TestNoteAlignFilter {
  ...
  private static final double[] CORRECT_X_POS = {0.75, 0.5303300858899107, 0.5303300858899107, 0.0,
      0.0, -0.5303300858899106, -0.5303300858899106, 0.75, 0.75};
  private static final double[] CORRECT_X_NEG = {-0.75, 0.5303300858899107, 0.5303300858899107, 0.0,
      0.0, -0.5303300858899106, -0.5303300858899106, -0.75, -0.75};

  private static final double[] CORRECT_Y_POS = {0.0, 0.5303300858899106, -0.5303300858899106, 0.75,
      0.75, 0.5303300858899107, -0.5303300858899107, 0.0, 0.0};
  private static final double[] CORRECT_Y_NEG = {0.0, 0.5303300858899106, -0.5303300858899106,
      -0.75, -0.75, 0.5303300858899107, -0.5303300858899107, 0.0, 0.0};
