...
public class TestNoteAlignFilter {
  ...
  void testNoteAlignFilterX(int index) {
    ...
    System.out.println("Expected Positive Red: " + CORRECT_X_POS[index]);
    System.out.println("Result: " + pdiRed.getXSpeed());
    System.out.println("Expected Negative Red: " + CORRECT_X_NEG[index]);
    System.out.println("Result: " + ndiRed.getXSpeed());
    System.out.println("Expected Positive Blue: " + CORRECT_X_POS[index]);
    System.out.println("Result: " + pdiBlue.getXSpeed());
    System.out.println("Expected Negative Blue: " + CORRECT_X_NEG[index]);
    System.out.println("Result: " + ndiBlue.getXSpeed());
  ...
  void testNoteAlignFilterY(int index) {
    ...
    System.out.println("Expected Positive Red: " + CORRECT_Y_POS[index]);
    System.out.println("Result: " + pdiRed.getYSpeed());
    System.out.println("Expected Negative Red: " + CORRECT_Y_NEG[index]);
    System.out.println("Result: " + ndiRed.getYSpeed());
    System.out.println("Expected Positive Blue: " + CORRECT_Y_POS[index]);
    System.out.println("Result: " + pdiBlue.getYSpeed());
    System.out.println("Expected Negative Blue: " + CORRECT_Y_NEG[index]);
    System.out.println("Result: " + ndiBlue.getYSpeed());
