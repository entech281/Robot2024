...
/**
 * The {@code SwitchedCamera} class contains fields and methods pertaining to
 * the function of the switched camera.
 */
public class SwitchedCamera {
	...
	public synchronized static void setUsbCamera(int camera) {
		...
		// For reference, 2495 SuffleBoard assumes that names of physical cameras are
		// "rPi Camera 0", "rPi Camera 1" and "rPi Camera 2",
