...
public class SwerveModule {
     ...
     */
    public SwerveModule(int drivingCANId, int turningCANId, int turningEncoderPort, boolean drivingInverted) {
        ...
        m_turningAbsoluteEncoder = new ThriftyEncoder(turningEncoderPort);
