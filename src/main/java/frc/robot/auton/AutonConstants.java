...
public class AutonConstants {
    ...
    public static final double DISTANCE_FROM_AREA_AFTER_SECOND_TURN_TO_CONE_PICKUP = 144.5; // the total of previous two
                                                                                            // constants
    ...
    public static final double DISTANCE_FROM_START_OF_CHARGING_STATION_TO_DOCKED_AT_CHARGING_STATION = 10; // todo put
                                                                                                           // proper
                                                                                                           // value
    ...
    public static final int ANGLE_BETWEEN_AREA_BEFORE_THIRD_TURN_AND_TOWARDS_CONE_NODE_SECOND_PART = 115; // the total
                                                                                                          // of this and
                                                                                                          // previous
                                                                                                          // angle is
                                                                                                          // supposed to
