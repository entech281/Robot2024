...
public final class RobotConstants {
  ...
  public static final class SwerveModuleConstants {
    ...
    public static final double WHEEL_DIAMETER_METERS = Units.inchesToMeters(3.81); // 4.125;  distance 8.62
  ...
  public static interface PID {
    ...
    public static interface SHOOTER {
      ...
      public static final double PODIUM_SPEED = 4500.0;
      public static final double SUBWOOFER_SPEED = 3100.0;
      public static final double AMP_SPEED = 3000.0 - 350.0;
    }
  ...
  public static interface TRANSFER {
    ...
    public static final double INTAKING_SPEED_SLOW = 0.05;
