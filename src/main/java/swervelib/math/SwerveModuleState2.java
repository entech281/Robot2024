...
public class SwerveModuleState2 extends SwerveModuleState {
  ...
  /**
   * Create a {@link SwerveModuleState2} based on the {@link SwerveModuleState}
   * with the radians per second defined.
   *
   ...
   * the wheel spins. If this is used with the PIDController class's continuous
   * input functionality, the furthest a
   * wheel will ever rotate is 90 degrees.
   *
   * @param desiredState                     The desired state.
   * @param currentAngle                     The current module angle.
   * @param lastState                        The last state of the module.
   * @param moduleSteerFeedForwardClosedLoop The module feed forward closed loop
   *                                         for the angle motor.
  ...
  public static SwerveModuleState2 optimize(SwerveModuleState2 desiredState, Rotation2d currentAngle,
    ...
    if (moduleSteerFeedForwardClosedLoop == 0) {
      ...
      // return new SwerveModuleState2(SwerveModuleState.optimize(desiredState,
      // currentAngle),
