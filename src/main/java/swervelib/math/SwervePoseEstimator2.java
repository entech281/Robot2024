...
/**
 * Clone of {@link SwerveDrivePoseEstimator} which takes into account gyroscope
...
public class SwervePoseEstimator2 // extends SwerveDrivePoseEstimator
{
   ...
   * measurements are 0.9 meters for x, 0.9
   ...
   *                                 position in meters, y position in
   *                                 meters, and heading in radians). Increase
   *                                 these numbers to trust your state
   *                                 estimate less.
   * @param visionMeasurementStdDevs Standard deviations of the vision pose
   *                                 measurement (x position in meters, y
   *                                 position in meters, and heading in radians).
   *                                 Increase these numbers to trust the
  ...
  public SwervePoseEstimator2(
    ...
    m_odometry = new SwerveDriveOdometry2(kinematics, gyroAngle, modulePositions, initialPoseMeters);
   ...
   *                                 matrix is in the form [x, y, theta]^T,
   ...
   * odometry pose estimate while still accounting
   ...
   * or so of the current pose estimate.
   *
   ...
   *                              SwerveModulePosition[])} then you must use a
   *                              timestamp with an epoch since FPGA
   ...
   * {@link SwerveDrivePoseEstimator#setVisionMeasurementStdDevs(Matrix)} or this
   * method.
   *
   ...
   * well as the pose that was observed based
